...
public class testtriangle : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        m_Mf.sharedMesh = GenerateTrianglex();
        m_Mf.sharedMesh = GenerateQuadx(new Vector3(4,0,2));
        m_Mf.sharedMesh = GenerateStripx(new Vector3(4, 0, 2),10, k=>.125f*Mathf.Sin(k*Mathf.PI*2*4) );
    ...
    Mesh GenerateTerrainFromHeightFunctionx(int nSegmentsX, int nSegmentsZ, Vector3 size, ComputeValueDelegate heightFunc)
    {
        ...
        return GeneratePlanex(nSegmentsX, nSegmentsZ, terrainFunc);
    }

    Mesh GenerateCylinderx(int nSegmentsTheta, int nSegmentsY, float radius, float height, ComputeValueDelegate rhoFunc)
    {
        ...
        return GeneratePlanex(nSegmentsTheta, nSegmentsY, cylFunc);

    }

    Mesh GenerateTrianglex()
    {
        Mesh mesh = new Mesh();
        mesh.name = "triangle";
    ...
    Mesh GenerateQuadx(Vector3 size)
    {
        Mesh mesh = new Mesh();
        mesh.name = "quad";
    ...
    Mesh GenerateStripx(Vector3 size, int nSegmentsX, ComputeHeigthXDelegate heightFunction)
    {
        Mesh mesh = new Mesh();
        mesh.name = "stripX";
    ...
    Mesh GeneratePlanex(int nSegmentsX, int nSegmentsZ, ComputeVertexPos posFunction)
    {
        Mesh mesh = new Mesh();
